        ...
        <div class="footer-main">
          <div class="footer-col">
            ...
            <div class="footer-social">
              ...
              <a href="https://www.facebook.com/the_shoolins" target="_blank" rel="noopener" title="Facebook" class="footer-social-icon">
                <svg viewBox="0 0 24 24" fill="currentColor" stroke="none"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
              </a>
              <a href="https://wa.me/${WHATSAPP_BUSINESS_NUMBER}" target="_blank" rel="noopener" title="WhatsApp" class="footer-social-icon">
                <svg viewBox="0 0 24 24" fill="currentColor" stroke="none"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
              </a>
              <a href="https://www.youtube.com/@the_shoolins" target="_blank" rel="noopener" title="YouTube" class="footer-social-icon">
